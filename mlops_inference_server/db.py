...
def fetch_all_btc_four_six() -> pd.DataFrame:
    ...
    with get_db_connection() as conn:
        query_get_ohlcv = f"""
            ...
            ;
            """
        logger.log(msg="2025-04-01 ~ 2025-06-30 BTC 데이터 fetch")
...
def get_model_aliases():
    ...
    try:
        ...
        if not aliases:
            logger.log(msg="등록된 모델 별칭이 없습니다.")
